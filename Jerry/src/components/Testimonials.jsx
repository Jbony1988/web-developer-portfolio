...
const Testimonials = () => {
  const reviews = [
    {
      name: "Scot Marcotte",
      position: "President Illinois Fathehood Initiative",
      // src: "images/testimonial/Illinois-Fatherhood-Initiative.png",
      desc: "“Illinois Fatherhood Intiative” Jerry thoroughly understood our needs, brought  us creative ideas and implemented an affordable web experience that hit the mark for our charity’s goals “",
    },
    {
      name: "Patrick Cary",
